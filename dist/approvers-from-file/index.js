...
exports.FileApproversRepository = void 0;
const fs = __importStar(__nccwpck_require__(7147));
const YAML = __importStar(__nccwpck_require__(4083));
class FileApproversRepository {
    constructor(path) {
        this.path = path;
    }
    findAll() {
...
exports.FileApproversRepository = FileApproversRepository;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ApproverState = void 0;
class ApproverState {
    constructor(approvers, approvals) {
        this.approvers = approvers;
        this.approvals = approvals;
    }
    numberOfValidApprovals() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ApproverState = exports.Approver = void 0;
var approver_1 = __nccwpck_require__(9409);
Object.defineProperty(exports, "Approver", ({ enumerable: true, get: function () { return approver_1.Approver; } }));
var approver_state_1 = __nccwpck_require__(6999);
Object.defineProperty(exports, "ApproverState", ({ enumerable: true, get: function () { return approver_state_1.ApproverState; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ApproversFromRepositoryUseCase = void 0;
const entities_1 = __nccwpck_require__(8120);
class ApproversFromRepositoryUseCase {
    constructor(approversRepository) {
        this.approversRepository = approversRepository;
    }
    execute() {
        const approverLoginNames = this.approversRepository.findAll();
        const approvers = approverLoginNames.map(name => new entities_1.Approver(name));
        return { approvers };
    }
}
exports.ApproversFromRepositoryUseCase = ApproversFromRepositoryUseCase;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.approversFromFileUseCaseFactory = void 0;
const file_approvers_repository_1 = __nccwpck_require__(7089);
const approvers_from_repository_use_case_1 = __nccwpck_require__(3636);
function approversFromFileUseCaseFactory(path) {
    const repository = new file_approvers_repository_1.FileApproversRepository(path);
    return new approvers_from_repository_use_case_1.ApproversFromRepositoryUseCase(repository);
}
exports.approversFromFileUseCaseFactory = approversFromFileUseCaseFactory;
...
const factories_1 = __nccwpck_require__(6205);
/*
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const command = (0, factories_1.approversFromFileUseCaseFactory)(inputs.approversFilePath);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(2079);
